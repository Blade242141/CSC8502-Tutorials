...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
	...
	sceneShader = new Shader("ShadowSceneVertex.glsl", "shadowSceneFrag.glsl");
	shadowShader = new Shader("ShadowVertex.glsl", "shadowFrag.glsl");
	...
	sceneDiffuse = SOIL_load_OGL_texture(TEXTUREDIR "BarrenReds.JPG", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	sceneBump = SOIL_load_OGL_texture(TEXTUREDIR "BarrenRedsDOT3.JPG", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
...
void Renderer::DrawShadowScene() {
	...
	viewMatrix = Matrix4::BuildViewMatrix(light->GetPos(), Vector3(0, 0, 0));
